...
Comprehensive guidelines for AI-assisted development across the entire MyBitcoinFuture ecosystem. Includes:
- **Organization Architecture** - Repository structure and technology stack
- **Critical LLM Blindspots** - Common AI development pitfalls and prevention
- **Repository-Specific Guidelines** - Development patterns for each repository
- **Security Guidelines** - Security requirements by repository
- **Testing Guidelines** - Testing requirements and best practices
- **Advanced Prompt Engineering** - Templates and anti-pattern prevention

### 🧹 [Cleanup Summary](docs/CLEANUP_SUMMARY.md)
Documentation of the comprehensive cleanup and organization tasks completed:
- **Critical Fixes** - Bug fixes and critical improvements
- **Storage Savings** - Space optimization and cleanup results
- **Organization Improvements** - Structural and branding consistency
- **Validation Results** - Quality assurance and verification

### 🏗️ [Organization Improvements](docs/ORGANIZATION_IMPROVEMENTS_SUMMARY.md)
Summary of documentation consolidation and test file organization:
- **Documentation Consolidation** - Standardized README files across repositories
- **Test File Organization** - Reorganized test structure and naming conventions
- **Development Experience** - Enhanced workflow and maintainability
